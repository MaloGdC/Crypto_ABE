...
BEGIN {
    ...
    require '/c/Users/galab/OneDrive/Documents/ecole/UQAC/Crypto/Projet/openssl-3.5.0/openssl-3.5.0/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/c/Users/galab/OneDrive/Documents/ecole/UQAC/Crypto/Projet/openssl-3.5.0/openssl-3.5.0/test/fips-and-base.cnf';
    shift;
...
if ($ARGV[0] eq '-jitter') {
    $std_openssl_conf = '/c/Users/galab/OneDrive/Documents/ecole/UQAC/Crypto/Projet/openssl-3.5.0/openssl-3.5.0/test/default-and-jitter.cnf';
    shift;
